...
const logoPath = path.join(__dirname, "../assets/foodexpiry.png");
          ...
          <div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #e5e7eb;">
            ...
            <div style="background:#16a34a;padding:20px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;">
                <img src="cid:foodexpiry-logo" alt="FoodExpiry" height="28" style="vertical-align:middle;margin-right:8px;" />
                FoodExpiry
              </h1>
            </div>
...
`;
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: `FoodExpiry - Food Expiry Reminder`,
    html,
    attachments: [
      {
        filename: "foodexpiry.png",
        path: logoPath,
        cid: "foodexpiry-logo",
      },
    ],
